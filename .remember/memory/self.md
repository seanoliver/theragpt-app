...
### Mistake: Redundant singleton pattern in service providers
**Wrong**:
```typescript
...
// Exporting both the class with getInstance() method and a constant instance
...
// TODO: Consider removing this exported constant and using ServiceProvider.instance directly
export const serviceProvider = ServiceProvider.instance
```

**Note**: The simplified pattern avoids the redundant getInstance() method. Eventually, the exported constant should also be removed in favor of directly using ServiceProvider.instance to make the singleton pattern more explicit and reduce indirection.
